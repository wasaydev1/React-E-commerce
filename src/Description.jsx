...
import { products } from './contextApi/ContextApi';

const Description = () => {
  let {id} = useParams()
  let { product } = useContext(products)
  let filteredProduct = product.filter((value) => value.id)
        ...
        <div className='main-container '>
          <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="px-5 pb-5">
              <div>
                <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{filteredProduct.title}</h5>
              </div>
